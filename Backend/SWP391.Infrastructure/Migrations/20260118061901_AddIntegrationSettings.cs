        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JiraProjectKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JiraIssueKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JiraIssueUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requirements_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GitHubCommits_CommitSha",
                table: "GitHubCommits",
                column: "CommitSha",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GitHubCommits_GroupId",
                table: "GitHubCommits",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GitHubCommits_UserId",
                table: "GitHubCommits",
                column: "UserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_GitHubCommits_Groups_GroupId",
                table: "GitHubCommits",
                column: "GroupId",
                principalTable: "Groups",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_GitHubCommits_Users_UserId",
                table: "GitHubCommits",
                column: "UserId",
                principalTable: "Users",
                principalColumn: "Id",
